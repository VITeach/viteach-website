  ...
  return (
    <div className="flex flex-col items-center justify-center gap-y-5 p-20">
      ...
      <div className="text-center text-gray-800">
        ...
        are driven by the passion for change. With an assortment of 161 active
        members, the club has been able to directly impact the lives of over
        4,83,400 students along the years.
      </div>
      <Carousel>{/* TODO: Add the carousel items */}</Carousel>
    </div>
  );
};
