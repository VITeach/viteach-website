...
const components = {
  h1: (props: HeadingProps) => (
    <h1
      className="text-4xl font-bold mt-8 mb-4 leading-tight text-red-900"
      {...props}
    />
  ),
  h2: (props: HeadingProps) => (
    <h2 className="text-3xl font-semibold mt-8 mb-3 leading-snug" {...props} />
  ),
  h3: (props: HeadingProps) => (
    <h3 className="text-2xl font-semibold mt-6 mb-2 leading-snug" {...props} />
  ),
  ...
  th: (props: ComponentPropsWithoutRef<'th'>) => (
    <th className="border px-4 py-2 bg-gray-100 font-semibold" {...props} />
  ),
